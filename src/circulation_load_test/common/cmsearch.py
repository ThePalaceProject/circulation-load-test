...
class CMSearch:
    ...
    def _handle_atom_feed(self, user: FastHttpUser, response):
    ...
    def _process_atom_feed(self, user: FastHttpUser, feed: AtomFeed) -> Optional[AtomFeed]:
    ...
    @classmethod
    def find_search_link(cls, user: FastHttpUser, url: str) -> Optional[str]:
